...
@section('title', 'Create Team Design Price - ' . config('app.name', 'Laravel'))

@section('header-title', 'Create Team Design Price')
@section('header-subtitle', 'Set custom design pricing for a team')
...
<div class="max-w-2xl mx-auto p-6 space-y-6">
    ...
    <form method="POST" action="{{ route('admin.design-prices.teams.store') }}" class="space-y-6">
        @csrf
