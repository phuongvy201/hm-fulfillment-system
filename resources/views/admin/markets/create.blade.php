...
@section('title', 'Create Market - ' . config('app.name', 'Laravel'))

@section('header-title', 'Create New Market')
@section('header-subtitle', 'Add a new market (US, UK, EU) to the system')
        ...
        <form method="POST" action="{{ route('admin.markets.store') }}">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    >
                    <p class="mt-1 text-xs text-gray-500">Unique code for the market (e.g., US, UK, EU)</p>
                </div>
                ...
                <div>
                    ...
                    <input 
                        ...
                        value="{{ old('name') }}"
                        required 
                        placeholder="e.g., United States, United Kingdom, European Union"
