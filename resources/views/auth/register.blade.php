    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-lg shadow-lg p-8 border border-gray-200">
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold mb-2" style="color: #000000;">Register</h1>
                <p class="text-sm" style="color: #666666;">Create a new account to get started</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-5">
                    <label for="name" class="block text-sm font-semibold mb-2" style="color: #000000;">Full Name</label>
                    <input 
                        type="text" 
                        id="name" 
                        name="name" 
                ...
                <div class="mb-5">
                    ...
                    <input 
                        ...
                        onblur="this.style.borderColor='#E5E5E5'; this.style.boxShadow='none';"
                    >
                    <p class="mt-1 text-xs" style="color: #999999;">Minimum 8 characters</p>
                </div>

                <div class="mb-6">
                    <label for="password_confirmation" class="block text-sm font-semibold mb-2" style="color: #000000;">Confirm Password</label>
                    <input 
                        type="password" 
            ...
            <div class="mt-6 text-center">
                <p class="text-sm" style="color: #666666;">
                    ...
                    <a href="{{ route('login') }}" class="font-semibold underline underline-offset-2 transition-colors" style="color: #F7961D;" onmouseover="this.style.color='#E6891A';" onmouseout="this.style.color='#F7961D';">
                        Sign in
                    </a>
                </p>
            </div>
